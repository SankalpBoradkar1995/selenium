...
//							.findElement(By.xpath("//input[@aria-label='New customer' and @name='newOrExisting']"));
				...
				try {
					...
					// String dialogBoxXPath = "//div[@class='ModalDialog-VDS__sc-1m9nirl-0
					// dJipA-d']";
					String dialogBoxXPath = "//*[@id=\"zipCode-overlay\"]/div[3]/div/div/div";
					WebElement dialogBox = wait
							.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(dialogBoxXPath)));
					...
					WebElement confirmLocationButton = driver
							.findElement(By.xpath("//button[@data-testid='zipConfirm']"));
...
//						driver.findElement(By.id(shopButtonId)));
				...
				wait.until(ExpectedConditions.elementToBeClickable(
						By.cssSelector(".categoryTilelets:nth-child(1) .tilelet-wrapper:nth-child(2) img")));
				driver.findElement(By.cssSelector(".categoryTilelets:nth-child(1) .tilelet-wrapper:nth-child(2) img"))
						.click();

				// Clicking on the console
				wait.until(ExpectedConditions.visibilityOfElementLocated(
						By.cssSelector("#\\31 000039815-Save\\ \\$60 #gridwallProductName > h2")));
				wait.until(ExpectedConditions.elementToBeClickable(
						By.cssSelector("#\\31 000039815-Save\\ \\$60 #gridwallProductName > h2")));
...
//				wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".glVjuF > .HitArea-VDS__sc-bc3yhn-0")));
				...
				try {
					...
					WebElement popup = wait
							.until(ExpectedConditions.presenceOfElementLocated(By.className(dialogClassName)));
					// Find the "New Customer" button and click it
					WebElement newCustomerButton = popup
							.findElement(By.xpath("//button[@data-testid='newCustomerCta']"));
					...
					if (resultForAccessoreisPage == true) {
						...
						System.out.println("SaleofInfo=" + resultForAccessoreisPage
								+ " , for Accessories page when we've opted out");
					}
